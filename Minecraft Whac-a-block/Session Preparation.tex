...
%///% Begin editable content
    ...
    \item The content is intended to be learnt through self-directed individual work, using the worksheet as guide.
					...
					Children can play the resulting game in groups at the end of the workshop.

    \item The learning platform is Minecraft on the RaspberryPi. 
		
					{\bfseries Please note, this workshop does NOT work on Minecraft for Windows, Minecraft for Mac or Minecraft Education Edition.}
...
\valuelist{6cm}{
    \item [Logging on] If you have enough RaspberryPis for the whole group, please ensure the children are logged on before we begin the session.

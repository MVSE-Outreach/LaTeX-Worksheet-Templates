...
\valuelist{6cm}{
    ...
    \item [Website Access] Please ensure your IT administrator has unblocked the Python and our Github site: https://github.com/MVSE-Outreach/ The easiest way to test this is to get a student (not a teacher) to open the websites and attempt to browse them. 

...
\def\workshoptitle{Python: Invaders From Space!}
\def\workshopsubtitle{Preparation Notes for Teachers}
\def\workshopauthor{Drum Ogilvie}
...
%///% Begin editable content
    ...
    \item This workshop is intended as a 90-minute activity.
    
    \item The workshop is intended for students age 9\textsuperscript{+} (years 5\textsuperscript{+}).

    \item The content is intended to be learnt through following a self-directed individual or pair work, using the worksheet as guide.

    \item The learning platform is the Python - Version 2.7 is required (This workshop will not work with Version 3).
...
\valuelist{6cm}{
    \item [Logging on] If you have enough PCs/Macs for the whole group, please ensure the students is logged on before we begin the session.
    
    \item [Provision of equipment] If you do not have enough PCs/Macs for the whole group, please let us know in advance. We may be able to provide laptops in order to run the session. If we provide laptops, we will need to allow at least an additional 15 minutes for handing them out and logging everybody on / getting set up.
    
    \item [Software Installation] Installation of Python 2.7 is required.
    
    \item [Website Access] Please ensure your IT administrator has unblocked our Github site: https://github.com/MVSE-Outreach/ The easiest way to test this is to get a student (not a teacher) to open the websites and attempt to browse them. 

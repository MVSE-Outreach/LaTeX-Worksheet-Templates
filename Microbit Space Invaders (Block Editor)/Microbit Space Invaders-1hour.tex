...
\screenshot{Initial-Forever.png}{Forever block in your project}
...
\actions {
	\item Add blocks to your game's code (extending the section we made earlier for displaying the defender) so that it matches the screenshot on the next page.
}
...
\actions {
	\item You already have an \enquote{on button A pressed} block from the \enquote{Input} tab in your project.

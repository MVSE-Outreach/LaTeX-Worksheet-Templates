...
\actions {
	\item Add blocks to your game's code so that it matches the screenshot below. 
          ...
          You will need to add a new \enquote{forever} block.
        
          You will need to use the \enquote{New variable} option from the drop down.
}

\screenshot[.7\linewidth-0.8cm]{New-variable.png}{Creating a new variable using the drop-down arrow}
...
\goals {
	Compile and save your game to your Micro:bit. When the Micro:bit powers on, you should now see the defender at bottom of the device.
}

...
%///% Begin editable content
    ...
    \item This workshop is intended to be a whole day activity.
    
    \item The workshops are intended for grades 1-8.

    \item The content is intended to be learnt in groups of three, but can be adapted to work as an individual activity or in groups of 2-4.

    \item Each student is assigned to a component - CPU, ALU/Memory and Display.

    \item No programming knowledge is required.
...
\valuelist{6cm}{
    \item [Resources needed] Computers with internet connection, a projector, Little Man Computer Simulator (use Rivens Java applet in preference to Atkinson version), old computers to take apart OR hardware such as processors, memory chips

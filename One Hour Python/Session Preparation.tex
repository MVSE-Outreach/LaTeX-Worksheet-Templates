...
%///% Begin editable content
    ...
    \item The workshop is intended for students with no programming experience, ages 7\textsuperscript{+} (years 4\textsuperscript{+}).

    \item The content is intended to be learnt through self-directed individual or pair work, using the worksheet as guide.

    \item The learning platform is Python.

    \item There are a number of versions of Python, we use the latest version (Python 3).
...
\valuelist{6cm}{
    ...
    \item [Software Installation] Installation of the latest version of Python 3 is required.

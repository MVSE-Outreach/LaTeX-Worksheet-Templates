...
\def\workshoptitle{Python Pi Camera: Getting the most of your Raspberry Pi camera module with Python}
...
%///% Begin editable content
    ...
    \item This workshop is intended as a 90 minutes activity
    
    \item The workshop is intended for students age ?? .

    \item The content is intended to be learnt through following a presentation and self-directed individual or pair work, using the worksheet as guide.

    \item The learning platform is the Raspberry Pi and the Pi Camera module.

    \item No additional software is required.

    \item The workshop is intended for students at beginner to intermediate level.
...
\valuelist{6cm}{
    \item [Logging on] If you have enough equipment for the whole group, please ensure everyone is logged on before we begin the session. (Still applicable?)
    
    \item [Provision of equipment] If you do not have enough Raspberry Pi or Pi Camera modules for the whole group, please let us know in advance. We may be able to provide hardware, including laptops, in order to run the session. If we provide laptops, we will need to allow at least an additional 15 minutes for handing them out and logging everybody on / getting set up.
    
    \item [Software Installation] No additional software installation is required.
    
    \item [Website Access] Please ensure your IT administrator has unblocked our Github site: https://github.com/MVSE-Outreach/ The easiest way to test this is to get a student (not a teacher) to open the website and attemtp to browse it. 

...
\def\workshoptitle{Python Pi Camera}
...
%///% Begin editable content
    ...
    \item The workshop is intended for students age 10\textsuperscript{+} (years 6\textsuperscript{+}).

    \item The content is intended to be learnt by teacher-led activities and individual or pair work, using the worksheet as guide.

    \item The learning platform is the RaspberryPi and the Pi Camera module.
...
\valuelist{6cm}{    
    \item [Provision of equipment] If you do not have enough RaspberryPi or Pi Camera modules for the whole group, please let us know in advance. We may be able to provide hardware, including laptops, in order to run the session. If we provide laptops, we will need to allow at least an additional 15 minutes for handing them out and logging everybody on / getting set up.

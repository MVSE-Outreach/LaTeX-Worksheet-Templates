...
\def\workshoptitle{Scratch: Projectile Modelling}
\def\workshopsubtitle{Preparation Notes for Teachers}
\def\workshopauthor{Nick Philips}
...
%///% Begin editable content
    ...
    \item This workshop is intended as a 2 hour activity (or so it seems)
    
    \item The workshop is intended for students years 1-6. (it's Scratch, and beginner-intermediate)

    \item The content is intended to be learnt through following a presentation and/or a worksheet, and completing exercises.
    
    \item The learning platform is Scratch, the popular online programming platform for kids.

    \item There are a number of versions of the Scratch platform, we use the latest online version.
		
		It is possible to adapt this workshop for older versions of Scratch (e.g. Scratch 1.0). We can also adapt this workshop for other block-based editors. Please talk to us if you would like to use a different platform.

    \item The workshop is intended for students at beginner to intermediate level, experience with Scratch is not required, but would be helpful.
...
\valuelist{6cm}{
    ...
    \item [Website Access] Please ensure your IT administrator has unblocked the Scratch website and our Github site: https://github.com/MVSE-Outreach/ The easiest way to test this is to get a student (not a teacher) to open the websites and attempt to browse them. 

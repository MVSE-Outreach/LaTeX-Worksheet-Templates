...
\def\workshoptitle{Scratch: Projectile Modeling}
...
%///% Begin editable content
    ...
    \item This workshop is intended as a 2 hour activity.
    
    \item The workshop is intended for students aged 10+ (years 6+).

    \item The content is intended to be learnt through individual or pair work, following the worksheet, and completing exercises.
    ...
    \item There are a number of versions of the Scratch platform, we use the latest online version.
		...
		It is possible to adapt this workshop for older versions of Scratch (e.g. Scratch 1.0). We can also adapt this workshop for other block-based editors (e.g. Micro:bit block editor). Please talk to us if you would like to use a different platform.

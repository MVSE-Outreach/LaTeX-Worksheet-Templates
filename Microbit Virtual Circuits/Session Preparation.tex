...
\def\workshoptitle{Scratch Flappy Bird}
...
%///% Begin editable content
    ...
    \item The workshops are intended for ages 7\textsuperscript{+} (years 4\textsuperscript{+}).
    ...
    \item Students do not need to have used Scratch before.

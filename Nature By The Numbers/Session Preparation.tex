...
%///% Begin editable content
    ...
    \item The workshop is intended for students age ?? . (marked as advanced)
    ...
    \item The workshop is intended for students at advanced level, with at least basic understanding of Python.
...
\valuelist{6cm}{
    ...
    \item [Provision of equipment] We will provide laptops beacuse of the required software in order to run the session. We will need to allow at least an additional 15 minutes for handing them out and logging everybody on / getting set up.

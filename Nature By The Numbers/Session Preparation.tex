...
\valuelist{6cm}{
    ...
    \item [Provision of equipment] We will provide laptops because of the required software in order to run the session. We will need to allow at least an additional 15 minutes for handing them out and logging everybody on / getting set up.

...
\def\workshoptitle{Nature By The Numbers - Intro To Data Science}
...
%///% Begin editable content
    ...
    \item The workshop is intended for students age 15\textsuperscript{+} (years 10\textsuperscript{+})

    \item The content is intended to be learnt through following a presentation and completing exercises.

    \item The learning platforms are VirtualBox, Ansible and Vagrant.

    \item No additional software is required.

    \item The workshop is intended for students at advanced level, with at least reasonable understanding of Python.
...
\valuelist{6cm}{
    ...
    \item [Provision of equipment] We will provide laptops because software required in order to run the session is complex to initially install and configure (students do not have to do this step). We will need to allow at least an additional 15 minutes for handing out the laptops  and logging everybody on / getting set up.
    
    \item [Software Installation] Software will be installed on the laptops provided.

...
\def\workshoptitle{One Day Python}
...
%///% Begin editable content
    ...
    \item This workshop is intended as a whole day activity.
    
    \item The workshop is intended for {\bfseries teachers} or students with no programming experience.
    ...
    \item There are a number of versions of Python, we use the latest version of Python 3.

    \item Participants do not need to have used Python before.
